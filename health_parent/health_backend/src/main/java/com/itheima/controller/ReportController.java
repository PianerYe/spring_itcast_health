...
//        data.put("setmealNames",setmealNames);
    ...
    public Result exportBusinessReport(HttpServletRequest request, HttpServletResponse response){
        try {
            ...
            Integer toderVisitsNumber = (Integer) result.get("toderVisitsNumber");
            ...
            row.getCell(7).setCellValue(toderVisitsNumber);//今日到诊数
            ...
            for (Map map : hotSetmeal){//热门套餐
                ...
                row.getCell(4).setCellValue(name);//贪残名称
            ...
            response.setHeader("content-Disposition","attachment;filename=report.xlsx");//指定以附近形式进行下载
